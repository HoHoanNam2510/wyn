...
import { addGrammarExample, deleteGrammarExample } from '@/app/actions/grammar';
...
export function ExamplesClient({
  ...
  function handleAdd() {
    ...
    startTransition(async () => {
      try {
        await addGrammarExample(patternId, { sentence: trimmed });
        setSentence('');
        // Optimistic update via revalidatePath will refresh server component;
        // add optimistic entry locally so UI responds immediately
        setExamples((prev) => [
          ...prev,
